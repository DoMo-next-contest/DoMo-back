...
import next.domo.subtask.dto.SubTaskAllUpdateDto;
...
public class SubTask {
    ...
    public void updateAllSubTask(SubTaskAllUpdateDto subTaskAllUpdateDto) {
        this.subTaskName = subTaskAllUpdateDto.getSubTaskName();
        this.subTaskOrder = subTaskAllUpdateDto.getSubTaskOrder();
        this.subTaskExpectedTime = subTaskAllUpdateDto.getSubTaskExpectedTime();
    }
